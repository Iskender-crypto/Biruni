<template>
  <div class="container">
    <div class="banner">
      <h1 class="title">Учись строить будущее</h1>
      <Course></Course>
    </div>
    <Search></Search>
  </div>
  ...
  <div class="about-us">
    <div class="container">
      ...
      <div class="about-us__info">
        ...
        <div class="about-us__video-relative relative">
          <video class="about-us__info-video" autoplay muted>
  ...
  <div class="feedback">
    <h3 class="feedback__title text-center mb-5">Что говорят о нас</h3>
    <swiper
      :modules="modules"
      :slidesPerView="5"
    ...
    >
      <swiper-slide
        ...
        :key="index"
        class="bg-white border-round-xl p-4 h-14rem flex flex-column justify-content-between swiper-slide"
      >
        <p class="mb-3 pr-2">
          {{ slideContent.comment }}
        </p>
        <div class="flex align-items-center">
          <img :src="slideContent.img" alt="" class="mr-3" />
          <div class="flex-column">
            <h4 class="mb-1">{{ slideContent.name }}</h4>
            <p>{{ slideContent.busyness }}</p>
          </div>
        </div>
      </swiper-slide>
    </swiper>
...
const products = ref([
  {
    img: "../../public/img/617fa55023c6a906cc955301_customers_ava-02.webp.png",
    name: "Rob Zuber",
    busyness: "CEO",
    comment:
  ...
  },
  {
    ...
    busyness: "CEO",
    comment:
      "iskenderely apply my knowledge in my work, found myself a new client",
  },
  {
    img: "../../public/img/617fa55023c6a906cc955301_customers_ava-02.webp.png",
    name: "Rob Zuber",
